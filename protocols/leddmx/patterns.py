...
# Keep the first UI sane. Nobody needs 210 buttons unless the goal is touchscreen war crimes.
CURATED_PATTERNS: dict[str, int] = {
    "Off": 0,
    "Forward 7 Colors": 3,
    "Backward 7 Colors": 4,
    "Strobe 7 Colors": 78,
    "Gradual 7 Colors": 81,
    "Open Curtain 7 Colors": 57,
    "Close Curtain 7 Colors": 58,
    "Forward Run 7 Colors": 120,
    "Backward Run 7 Colors": 121,
    "Forward Swab 7 COLORS": 199,
    "Backward Swab 7 COLORS": 200,
}
